...
function getFunction(accessor: string[], functions: Hash<InterpolationFunction>, location: Location): InterpolationFunction {
...
type EvaluationFunction = (args: any[], context: Context, functions: Hash<InterpolationFunction>) => Attribute;
...
const evaluators: Hash<EvaluationFunction> = {
  ...
  funcall(args, context, functions: Hash<InterpolationFunction>): Attribute {
 ...
 */
export function evaluate(expression: Expression, context: Context = {}, functions: Hash<InterpolationFunction> = {}): Attribute {
